...
import { Plus, Trash2, Edit, X, ChevronDown, ChevronRight } from "lucide-react";

export default function APQPTable() {
  const ACTIVITY_PHASES = [
    "Plan & define phase",
    "Product design & development (not product design responsible)	",
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-5xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold text-gray-800">APQP Time Plan</h1>
          <button
            onClick={() => {
              setIsAdding(true);
              setIsEditing(false);
            ...
            title="Add a new activity phase"
          >
            <Plus size={20} />
            Add Activity
          </button>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-100 text-left">
                ...
                <th className="px-6 py-3 text-gray-700 font-semibold">Activity</th>
                      ...
                      <div className="flex gap-2">
                        <div className="relative group">
                          ...
                          <span className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-max px-3 py-1 bg-gray-800 text-white text-xs rounded shadow-md opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                            Edit this activity and its sub-activities
                          </span>
                        </div>

                        <div className="relative group">
                          <button
                            onClick={() => addSubActivityToExisting(activityIndex)}
                    ...
                    <tr key={`${activityIndex}-${subIndex}`} className="border-t bg-gray-50">
                      ...
                      <td className="px-6 py-3">
                        <button
                          ...
                          title="Delete this sub-activity"
                        >
                          <Trash2 size={18} />
                        </button>
                      </td>
              ...
              <div className="px-6 py-4 space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <h4 className="text-lg font-medium text-gray-700">Sub-activities</h4>
                    <button
                      ...
                      title="Add another sub-activity field"
                    >
                      <Plus size={16} /> Add Sub-activity
                    </button>
                  </div>
