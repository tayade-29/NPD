...
const ProcessTracker = ({ isOpen, onClose, currentStatus, onStatusUpdate, selectedEnquiry }) => {
  ...
  const processes = {
    1: { name: "Plan and Define ", subProcesses: { 1: "Enquiry Recieved", 2: "Sent to Toolmaker", 3: "Decide Feasibility", 4:"Prepare Quotation", 5:"Take Confirmation (P.O.)",6:"Decide APQP Time Plan", 7:"Get Tool Design"} },
