            ...
            <div className="max-w-5xl mx-auto">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <button
                        ...
                        title={buttonLabels?.addActivity?.title || "Add new item"}
                    >
                        <Plus size={20} />
                        {buttonLabels?.addActivity?.label || "Add"}
                    </button>
                </div>
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex gap-2">
                                                <button
                                                    ...
                                                    title={buttonLabels?.editActivity?.title || "Edit"}
                                                >
                                                    <Edit size={18} />
                                                </button>
                                                <button
                                                    ...
                                                    title={isCheckpoints ? (buttonLabels?.addDescription?.title || "Add Description") : (buttonLabels?.addSubActivity?.title || "Add Sub-activity")}
                                                >
                                                    <Plus size={18} />
                                                </button>
                                                <button
                                                    ...
                                                    title={buttonLabels?.deleteActivity?.title || "Delete"}
                                                >
                                                    <Trash2 size={18} />
                                                </button>
                                            </div>
                                        ...
                                        <tr key={`${activityIndex}-${subIndex}`} className="border-t bg-gray-50">
                                            ...
                                            <td className="px-6 py-3">
                                                <button
                                                    ...
                                                    title={buttonLabels?.deleteSubActivity?.title || "Delete"}
                                                >
                                                    <Trash2 size={18} />
                                                </button>
                                            </td>
